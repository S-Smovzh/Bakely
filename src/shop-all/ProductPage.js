            ...
            <section className="B-M Grid">
              <section className="Col-F Flex F-F-C-N">
                ...
                <div
                  ...
                  <img src={product.imgSrc} alt={product.imgDescription} className="Image-P Image-L A-S-C"/>
              ...
              <section className="Col-S Grid">
                ...
                <section className="Item-D Grid">
                  ...
                  <div
                    className={`Flex ${(width > 768 && width < 992) ? 'J-C-F-S' : 'J-C-C'} A-I-F-E fill-width fill-height`}>
                      ...
                      <Link to={location.pathname.substr(0, location.pathname.lastIndexOf('/')) + '/' + similar.id}>
                        <Card className="Grid" backType="gray">
                          ...
                          <div className="It-Inf Grid F-H">
                            <h4 className="Product-Name Flex F-F-C-N T-C font-weight_700 F-W">
                              {similar.name}
                            </h4>
                            <div className="Prod-Pr Flex F-F-C-N J-C-F-E T-C F-W">
                              ...
                              {isDiscounted ? (
                                <p
                                  className="Price font-weight_200 helper Crossed F-W">
